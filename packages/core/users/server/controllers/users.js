 ...
 *
 * @param mailOptions - the email service
 */
...
module.exports = function(MeanUser) {
    return {
         ...
         * Logout
         *
         * @param req - credentials of the users
         * @param res - the output of the result
         */
         ...
         * 
         * @param req - the credentails required to create a user
