    ...
    return {
        ...
        */
        ...
        findTags: function (req, res){
            ...
            * count, has_synonyms, name, synonyms and default .wrapper configs
            */
            var url = 'https://api.stackexchange.com/2.2/users/696885/tags?order=desc&sort=popular&site=stackoverflow&filter=!bNKX0p1Jb)Lh1K'
        }
    }
}
